...
| agent_browser_dialog_status | value-add | in-browser | opendia | browser_dialog_status | in-progress | bench:dialog_status |
...
| agent_browser_frame_switch | value-add | in-browser | opendia | browser_frame_switch | in-progress | bench:frame_switch |
...
| agent_browser_profiler_start | value-add | in-browser | opendia | browser_profiler_start | in-progress | bench:profiler_start |
| agent_browser_profiler_stop | value-add | in-browser | opendia | browser_profiler_stop | in-progress | bench:profiler_stop |
...
| agent_browser_trace_start | value-add | in-browser | opendia | browser_trace_start | in-progress | bench:trace_start |
| agent_browser_trace_stop | value-add | in-browser | opendia | browser_trace_stop | in-progress | bench:trace_stop |
...
| agent_browser_window_new | value-add | in-browser | opendia | browser_window_new | in-progress | bench:window_new |
